...
pathFolder = "/media/tushar/HDD/Academic/Semester_3/CAD_Computer Aided Diagnosis_5_Credits/Lab/Challenge-2 Data/train"#the pathfolder for Challenge-2 train data.
...
df.to_csv('train_fetures_extraction_bcc_bkl_mel.csv', index = False)
