...
pathFolder = "/media/tushar/HDD/Academic/Semester_3/CAD_Computer Aided Diagnosis_5_Credits/Lab/Testing Data/Challenge_1_testingData" #the pathfolder for Challenge-1 test data.
...
df.to_csv('TEST_Challenge_1_fetures_extraction_les_nv.csv', index = False)
