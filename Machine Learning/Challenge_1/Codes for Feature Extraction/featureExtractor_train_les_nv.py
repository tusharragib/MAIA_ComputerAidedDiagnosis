...
pathFolder = "/media/tushar/HDD/Academic/Semester_3/CAD_Computer Aided Diagnosis_5_Credits/Lab/Challenge-1 Data/train"#the pathfolder for Challenge-1 train data.
...
df.to_csv('train_fetures_extraction_les_nv.csv', index = False)
